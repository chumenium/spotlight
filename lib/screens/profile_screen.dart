        ...
        builder: (context, authProvider, _) {
          ...
          return Container(
            ...
            child: ListTile(
              ...
              onTap: () async {
                await _showDeleteAccountConfirmation(context, authProvider);
              },
              contentPadding: EdgeInsets.zero,
            ),
          );
      ...
      builder: (context) => AlertDialog(
        ...
        content: Column(
          ...
          children: [
            ...
            const SizedBox(height: 12),
            _buildDeleteInfoItem('ユーザー名'),
            _buildDeleteInfoItem('アイコン'),
            _buildDeleteInfoItem('すべての投稿コンテンツ'),
            const SizedBox(height: 12),
            Text(
              'この操作は取り消せません。',
              style: TextStyle(
